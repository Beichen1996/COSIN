...
class ResNet(nn.Module):
    ...
    def forward(self, x, feature=False):
        ...
        x1 = self.layer1(x)  # B x 16 x 32 x 32
        #print(x1.shape, 'asdas')
        x2 = self.layer2(x1)  # B x 32 x 16 x 16
        #print(x2.shape, 'asdas')
        x3 = self.layer3(x2)  # B x 64 x 8 x 8
        #print(x3.shape, 'asdas')
...
class statenet(nn.Module):
    def __init__(self, feature_sizes=[32, 16, 8], num_channels=[64, 128, 256], interm_dim=128):
    ...
    def forward(self, features):
        ...
        #print(out1.shape)
        out1 = torch.nn.functional.relu(self.FC1(out1))

        out2 = self.GAP2(features[1])
        out2 = out2.view(out2.size(0), -1)
        out2 = torch.nn.functional.relu(self.FC2(out2))

        out3 = self.GAP3(features[2])
        out3 = out3.view(out3.size(0), -1)
        out3 = torch.nn.functional.relu(self.FC3(out3))
