...
def _data_transforms_cifar10_clean():
    CIFAR_MEAN = [0.49139968, 0.48215827, 0.44653124]
    CIFAR_STD = [0.24703233, 0.24348505, 0.26158768]
...
def get_dataloader_CIFAR10_clean(datadir, train_bs):
    #for feature extraction without data augmentation
    dl_obj = CIFAR10_truncated

    transform_train, transform_test = _data_transforms_cifar10_clean()

    train_ds = dl_obj(datadir, train=True, transform=transform_train, download=True, returnindex = 1)
...
def load_partition_data_cifar10(dataset, data_dir, partition_method, partition_alpha, client_number, batch_size, samplefile=None, trans = None):
    BB = batch_size
